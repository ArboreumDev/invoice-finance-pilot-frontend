                        ...
                        <Stat>
                            <StatLabel fontSize="lg">
                                <Stack direction="row">
                                    ...
                                    <Tooltip
                                        label="total amount due if invoices are being repaid according to terms (at the last possible date) ">
                                        <InfoIcon/>
                                    </Tooltip>
                                </Stack>
                            </StatLabel>
                        ...
                        <Stat>
                            <StatLabel fontSize="lg">
                                <Stack direction="row">
                                    ...
                                    <Tooltip
                                        label="total amount due if all invoices were repaid by the end of this day ">
                                        <InfoIcon/>
                                    </Tooltip>
                                </Stack>
                            </StatLabel>
